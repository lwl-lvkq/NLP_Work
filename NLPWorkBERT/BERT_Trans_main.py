...
def collate_fn(data):
    ...
    token = BertTokenizer.from_pretrained('bert-base-uncased', cache_dir='models')
...
def main():
    pretrained_model = BertModel.from_pretrained('bert-base-uncased', cache_dir='models')

    model = BERT_Model(pretrained_model)
